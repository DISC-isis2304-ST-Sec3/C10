...
public interface Reservan_habitacionesRepository extends JpaRepository<Reservan_habitaciones, Integer> {
    ...
    Collection<UsanSpa> darReservan_habitaciones();
    ...
    UsanSpa darReservan_habitaciones(@Param("Numero_reserva") int Num_reserva,
    ...
    void insertarReservan_habitaciones(@Param("Numero_reserva") int id_SPA,
            @Param("Numero_habitacion") int id_ReservaSPA);
    ...
    void actualizarReservan_habitaciones(@Param("Numero_reserva") int id_SPA,
            @Param("Numero_habitacion") int id_ReservaSPA);
    ...
    void eliminarReservan_habitaciones(@Param("Numero_reserva") int id_SPA,
            @Param("Numero_habitacion") int id_ReservaSPA);
